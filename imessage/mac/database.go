...
func (mac *macOSDatabase) PrepareDM(_ string, _ ...imessage.ExtraParams) error {
	// Nothing needed here
	return nil
}

func (mac *macOSDatabase) SendMessageBridgeResult(chatID, messageID string, eventID id.EventID, success bool, extra ...imessage.ExtraParams) {
}

func (mac *macOSDatabase) SendBackfillResult(chatID, backfillID string, success bool, idMap map[string][]id.EventID, extra ...imessage.ExtraParams) {
}

func (mac *macOSDatabase) SendChatBridgeResult(guid string, mxid id.RoomID, extra ...imessage.ExtraParams) {
}
